...
def github_headers():
  return {
    ...
    'Authorization': 'Basic ' + base64.b64encode(os.environ.get('GITHUB_BASIC').encode('utf-8')).decode('utf-8') if os.environ.get('GITHUB_BASIC') else 'token ' + os.environ.get('GITHUB_TOKEN')
  }
